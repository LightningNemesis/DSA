...
public class frequency_of_elements {
    public static void main(String[] args) throws IOException {
        ...
        new hashing_solver_frequency_of_elements().frequency_count_efficient(arr);
...
class hashing_solver_frequency_of_elements {
    ...
    void frequency_count_efficient(int[] arr) {
        int n = arr.length;
        LinkedHashMap<Integer, Integer> lhm = new LinkedHashMap<Integer, Integer>();
        for (int i : arr) {
            lhm.put(i, lhm.getOrDefault(i, 0) + 1); // Putting value of key i, if exists or a default value + Incrementing it by 1
        }
